...
plt.text(x=12-5, y=95, s='EAT', c='sandybrown',
         horizontalalignment='center',
         verticalalignment='center', size=15)
plt.text(x=18-6, y=95, s='FNN', c='sandybrown',
         horizontalalignment='center',
         verticalalignment='center', size=15)
plt.text(x=24-7, y=95, s='LA', c='sandybrown',
         horizontalalignment='center',
         verticalalignment='center', size=15)
plt.text(x=1, y=75, s='Baselines', c='sandybrown',
         horizontalalignment='center',
