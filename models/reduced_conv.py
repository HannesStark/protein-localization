...
class ReducedConv(nn.Module):
    def __init__(self, input_dim: int = 1024, hidden_dim: int = 32, output_dim: int = 11, dropout: float = 0.25):
        """
        ...
        self.conv1 = nn.Conv1d(input_dim, input_dim, 3, stride=1)
        self.conv2 = nn.Conv1d(input_dim, input_dim, 3, stride=1)
        self.conv2 = nn.Conv1d(input_dim, input_dim, 3, stride=2)
