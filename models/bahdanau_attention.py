...
class BahdanauAttention(nn.Module):
    def __init__(self, embeddings_dim=1024, output_dim=11, dropout=0.25, kernel_size=9, conv_dropout: float = 0.25):
        ...
        self.attention_convolution = nn.Conv1d(embeddings_dim, embeddings_dim, 1, stride=1,
                                               padding=0)
    ...
    def forward(self, x: torch.Tensor, mask) -> torch.Tensor:
        ...
        attention = self.attention_convolution(o)  # [batch_size, embeddings_dim, sequence_length]
