...
def parse_arguments():
    ...
    p.add_argument('--config', type=argparse.FileType(mode='r'), default='configs/conv_max_avg_pool_middle_concat.yaml')
    p.add_argument('--experiment_name', type=str, help='name that will be added to the runs folder output')
    p.add_argument('--num_epochs', type=int, default=2500, help='number of times to iterate through all samples')
    p.add_argument('--batch_size', type=int, default=1024, help='samples that will be processed in parallel')
    p.add_argument('--patience', type=int, default=80, help='stop training after no improvement in this many epochs')
